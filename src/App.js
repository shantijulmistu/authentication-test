      ...
      <div className="google-sign-in">
        ...
        <div className="btn-group">
          {user.uid ?
            ...
            :
            <button onClick={handleGoogleSignIn} className="sign-in-button"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
              width="48" height="30"
              viewBox="0 0 48 48">
      ...
      <div className="github-sign-in">
        ...
        <div className="btn-group">
          {user.uid ?
            <button onClick={handleSignOut} className="sign-out-button">Sign Out</button>
            :
            <button onClick={handleGithubSignIn} className="sign-in-button"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
              width="48" height="40"
              viewBox="0 0 50 50">
